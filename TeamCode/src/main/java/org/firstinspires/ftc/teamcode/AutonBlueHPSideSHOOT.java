...
@Autonomous(name = "Blue HP Side (Shooting)", group = "Autonomous", preselectTeleOp = ("LiLiLocalizationTest"))

public class AutonBlueHPSideSHOOT extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action trajectory1 = myBot.actionBuilder(new Pose2d(62.5, -18, Math.toRadians(0)))
                .splineToLinearHeading(new Pose2d(53, -16, Math.toRadians(23.5)), Math.toRadians(180))
                //shoot
                .build();
