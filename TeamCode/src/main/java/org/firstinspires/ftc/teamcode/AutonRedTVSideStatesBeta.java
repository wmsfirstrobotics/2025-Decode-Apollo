...
public class AutonRedTVSideStatesBeta extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action trajectory2 = myBot.actionBuilder(new Pose2d(-23.5, 23.5, Math.toRadians(-47)))
                ...
                .splineToLinearHeading(new Pose2d(-10.5, 27, Math.toRadians(-275)), Math.toRadians(-270), new TranslationalVelConstraint(speed))
                .build();
                // start intaking motor

        Action trajectory3 = myBot.actionBuilder(new Pose2d(-10.5, 27, Math.toRadians(-275)))
        ...
        Action trajectory4 = myBot.actionBuilder(new Pose2d(-10.5, 47.5, Math.toRadians(-275)))
                ...
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-23.5, 23.5, Math.toRadians(-45)), Math.toRadians(-200), new TranslationalVelConstraint(speed))
                .build();
                // start shooting stuff

        Action trajectory5 = myBot.actionBuilder(new Pose2d(-23.5, 23.5, Math.toRadians(-45)))

                .splineToLinearHeading(new Pose2d(15, 27, Math.toRadians(-270)), Math.toRadians(-270), new TranslationalVelConstraint(speed))
                .build();
//start intaking motor
        ...
        Action trajectory7 = myBot.actionBuilder(new Pose2d(15, 50.5, Math.toRadians(-270)))
                ...
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-23.5, 23.5, Math.toRadians(-43)), Math.toRadians(-200), new TranslationalVelConstraint(speed))
                .build();
        //start shooting stuff

        Action trajectory8 = myBot.actionBuilder(new Pose2d(-23.5, 23.5, Math.toRadians(-43)))

                .splineToLinearHeading(new Pose2d(42.5, 27, Math.toRadians(-270)), Math.toRadians(-270), new TranslationalVelConstraint(speed))
                .build();
                //start intaking motor
